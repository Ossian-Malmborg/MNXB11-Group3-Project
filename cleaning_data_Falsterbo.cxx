...
int main() {
    ...
    std::ofstream outputFile("Falsterbo.csv");
    ...
    while (std::getline(inputFile, line)) {
        ...
        if (date >= "1983-01-01" && date <= "2022-12-31" && (time == "06:00:00"|| time =="18:00:00")) {
    ...
    std::cout << "Filtered data has been saved to 'Falsterbo.csv'\n";
    return 0;
}